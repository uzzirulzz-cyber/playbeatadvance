...
export const SmartProjectorsSection: React.FC = () => {
  ...
  return (
    <section id="section-smart-projectors" className="w-full py-12 relative">
      {/* Premium Background Effects */}
      <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-br from-[#FFD21F]/20 to-blue-600/10 blur-3xl rounded-full" />
        <div className="absolute bottom-0 right-1/3 w-80 h-80 bg-gradient-to-tl from-purple-600/10 to-[#FFD21F]/10 blur-3xl rounded-full" />
      </div>
